...
func TestServiceHelperValidationBranches(t *testing.T) {
	...
	if _, err := svc.exchangeAuthorizationCode("wrong", "", "https://client.test/callback", code, "verifier-verifier-verifier-verifier"); err == nil {
		t.Fatal("exchangeAuthorizationCode should reject wrong client")
	}
}
