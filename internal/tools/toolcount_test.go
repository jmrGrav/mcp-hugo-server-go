...
//	content.write:       20  — create_page, update_page, delete_page, upload_page_asset,
//	                            delete_page_asset, begin_asset_upload, upload_asset_chunk,
//	                            commit_asset_upload (#1196), get_mutation_status, get_rate_limits,
