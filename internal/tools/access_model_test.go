...
func TestVerifiedToolScopeMatrix(t *testing.T) {
	want := map[string]string{
		...
		"begin_asset_upload":   "write",
		"upload_asset_chunk":   "write",
		"commit_asset_upload":  "write",
		"get_mutation_status":  "write",
		"get_rate_limits":      "write",
		"plan_content_change":  "",
		"apply_content_plan":   "write",
		"rollback_change":      "write",
		"list_page_snapshots":  "write",
		"create_bundle":        "write",
		"delete_bundle":        "write",
		"plan_bundle_change":   "",
		"apply_bundle_plan":    "write",
		"rollback_bundle":      "write",
		"create_change_set":    "write",
		"build_site":           "write",
		"preview_build":        "write",
...
func TestCurrentAccessHierarchyStillMatchesDesignAnchor(t *testing.T) {
	...
	if got := len(writepkg.Defs()); got != 20 {
		t.Fatalf("write tool count = %d, want 20", got)
	}
