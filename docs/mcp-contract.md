...
| Tool                    | Envelope    | Notes                                        |
|-------------------------|-------------|----------------------------------------------|
| `get_full_page_markdown`| flat        | `page`                                       |
| `get_page_frontmatter`  | flat        | `frontmatter`                                |
| `get_related_content`   | flat        | `related`                                    |
| `build_agent_context`   | flat        | `context`                                    |
| `export_agent_context`  | flat        | `export.pages`, `export.total`               |
| `search_content`        | structured  | `data.pages`, `data.total`, pagination echo  |
| `explain_site_structure`| structured  | `data.sections`, `data.languages`, `data.summary` |
...
| `diff_page`             | structured  | `data` (diff result)                         |
